...
- `3 фильма` из TMDb `Now Playing (US)`
...
- `PUBLISH_SLOTS` — по умолчанию `09:15,12:20,15:15,17:20,19:15,21:20`
...
PUBLISH_SLOTS="09:15,12:20,15:15,17:20,19:15,21:20"
```
...
- источники только TMDb `Now Playing` и `On The Air`
